...
const HERO_URLS = ['/static/image/index/iron_man.jpg','/static/image/index/captain_America.jpg','/static/image/index/spider_man.jpg',
    '/static/image/index/black_widow.jpg','/static/image/index/Hulk.jpg','/static/image/index/Thor.jpg',
    '/static/image/index/Dead_Pool.jpg','/static/image/index/Dr.Strange.jpg','/static/image/index/panther.jpg']
const HEROES= ['钢铁侠','美国队长','蜘蛛侠','黑寡妇','绿巨人','雷神','死侍','奇异博士','黑豹']
const HAIRSTYLE_URLS = ['/static/image/make-poster/hs1-1.png','/static/image/make-poster/hs2-2.png','/static/image/make-poster/hs3-3.png',
    '/static/image/make-poster/hs4-4.png','/static/image/make-poster/hs5-5.png']
const WEAPON_URLS = ['/static/image/make-poster/shield.png','/static/image/make-poster/hammar.png','/static/image/make-poster/gun1.png',
    '/static/image/make-poster/gun2.png','/static/image/make-poster/gun3.png']
const FACIAL_URLS = ['/static/image/make-poster/b1.png','/static/image/make-poster/b2.png','/static/image/make-poster/g1.png',
    '/static/image/make-poster/g2.png','/static/image/make-poster/g3.png']
const BGIS = ['/static/image/make-poster/bg1.jpg','/static/image/make-poster/bg2.jpg','/static/image/make-poster/bg3.jpg']
